                ...
                <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-[#617E5B] bg-opacity-50 border-r">
                    ...
                    <div class="flex flex-col flex-grow px-4 mt-5">
                        ...
                        <nav class="flex-1 space-y-1 mt-10">
                            ...
                            <ul>
                                <li>
                                    <a class="{{ request()->routeIs('admin.reports') ? 'bg-white text-gray-700 fill-gray-700' : 'text-white fill-white' }} inline-flex  items-center w-full px-4 py-2 mt-1    transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100  hover:scale-95 hover:text-gray-700 hover:fill-gray-700"
