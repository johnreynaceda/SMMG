...
use DB;
use App\Models\Medtech as medtechModel;

class Medtech extends Component implements Tables\Contracts\HasTable
{
    use Tables\Concerns\InteractsWithTable;
    use WithFileUploads;
    public function render()
    {
        return view('livewire.admin.medtech', [
            'medtech_count' => medtechModel::count(),
        ]);
    }
    ...
    protected function getTableHeaderActions()
    {
        ...
        return [
            ...
            Action::make('new_medtech')->label('Add New Med Tech')->button()->icon('heroicon-o-plus-circle')->action(function ($record, $data) {
                // dd($data['attachment']);
                DB::beginTransaction();
                $user = User::create([
                ...
                DB::commit();
                        ...
                        Fieldset::make('MED TECH INFORMATION')
                            ->schema([
